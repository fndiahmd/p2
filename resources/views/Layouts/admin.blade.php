...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('images/logo-wikrama.png') }}">
    ...
    <div class="wrapper">
        <nav id="sidebar">
            <div class="sidebar-header">
                <h3 class="mb-0 text-center">PEMAS</h3>
        ...
        <div id="content">
            <nav class="navbar navbar-expand-lg" style="background-color: #15548f; color: white">
